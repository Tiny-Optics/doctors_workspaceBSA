    ...
    <section class="relative overflow-hidden">
      <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
        ...
        <div class="text-center">
          <h1 class="text-4xl md:text-5xl font-bold text-white mb-4">Working Parties</h1>
          <p class="text-white max-w-2xl mx-auto">
            Browse documents by disease-specific working party. Open a category to view and download files.
          </p>
        </div>
      </div>
    </section>
    ...
    <section v-else-if="!loading && categories.length === 0" class="py-12">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-xl shadow-lg p-12 text-center">
          ...
          <h3 class="text-2xl font-semibold text-gray-900 mb-2">No Working Party Categories Available</h3>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          <router-link
            ...
            :key="category.id"
            :to="{ name: 'working-parties-list', params: { slug: category.slug } }"
...
import type { WorkingPartyCategory } from '@/types/workingParty'
...
async function loadCategories() {
  ...
  try {
    ...
    console.error('Failed to load working party categories:', error)
  } finally {
    loading.value = false
  }
}
